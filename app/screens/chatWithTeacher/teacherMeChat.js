...
export class TeacherMeChat extends React.Component {
  ...
  static renderNavigationTitle = (navigation, user) => (
    <TouchableOpacity onPress={() => TeacherMeChat.onNavigationTitlePressed(navigation, user)}>
  ...
  static renderNavigationAvatar = (navigation, user) => (
    <TouchableOpacity onPress={() => TeacherMeChat.onNavigationAvatarPressed(navigation, user)}>
